...
const revenuevar = [
  { x: "current month", value: 1060 },
  { x: "previous-month", value: 1320 },
];
...
var data = anychart.data.set([
  ["Current month", 2, 0, 1, 0],
  ["Previous month", 1, 1, 1, 0],
]);
